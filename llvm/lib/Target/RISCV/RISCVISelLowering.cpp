...
SDValue RISCVTargetLowering::LowerOperation(SDValue Op,
  ...
  case ISD::BSWAP:
    assert(Subtarget.hasStdExtZbpbo());
  case ISD::BITREVERSE: {
    MVT VT = Op.getSimpleValueType();
    if (VT.isFixedLengthVector()) {
      assert(Subtarget.hasStdExtZvbb());
    ...
    /*
    case ISD::BSWAP:
      assert(Subtarget.hasStdExtZbpbo() && "Unexpected custom legalization");
      return DAG.getNode(RISCVISD::BREV8, DL, VT, Op.getOperand(0));
...
void RISCVTargetLowering::ReplaceNodeResults(SDNode *N,
  ...
  case ISD::BITREVERSE: {
    ...
    assert((VT == MVT::i8 || VT == MVT::i16 ||
           ...
           Subtarget.hasStdExtZbpbo() && "Unexpected custom legalisation");
  ...
  case ISD::INTRINSIC_WO_CHAIN: {
    ...
    case Intrinsic::riscv_fsr: {
      ...
      unsigned Opc =
          IntNo == Intrinsic::riscv_fsl ? RISCVISD::FSLW : RISCVISD::FSRW;
