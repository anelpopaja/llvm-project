...
// RUN: not %clang -target riscv32-unknown-elf -march=rv32izpsfoperand -### %s -c 2>&1 | \
...
// RUN: not %clang -target riscv32-unknown-elf -march=rv32izpsfoperand -menable-experimental-extensions -### %s -c 2>&1 | \
...
// RUN: not %clang -target riscv32-unknown-elf -march=rv32izpsfoperand0p1 -menable-experimental-extensions -### %s -c 2>&1 | \
...
// RUN: %clang -target riscv32-unknown-elf -march=rv32izpsfoperand0p911 -menable-experimental-extensions -### %s -c 2>&1 | \
